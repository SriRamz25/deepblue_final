...
stats = compute_user_stats('user3@upi')
rec = get_receiver_summary_for_user('user3@upi','recv5@upi')
profile = {'user_id':'user3@upi','known_devices':[], 'trust_score':0, 'risk_tier':'BRONZE'}
ctx = UserContext(profile, stats, rec)

txn = {'amount':100, 'receiver':'recv5@upi', 'device_id':'dev-test-1', 'ip_city':'Mumbai'}
